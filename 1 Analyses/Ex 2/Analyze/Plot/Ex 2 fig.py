...
ax1.set_title('Item-Specific Group', fontsize = 16, pad = 15, fontweight = "bold")
...
##Add labels, legend, and set tick marks
ax2.set_title('Relational Group', fontsize = 16, pad = 15, fontweight = "bold")
...
##Add labels, legend, and set tick marks
ax3.set_title('Read Group', fontsize = 16, pad = 15, fontweight = "bold")
